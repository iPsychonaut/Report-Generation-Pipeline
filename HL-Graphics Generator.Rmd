...
#gen_graphics_from_row <- function(row) {
  ...
  sample_table <- plot_ly(
    ...
    header = list(
      ...
      height = 50),
    cells = list(
      values = cbind(c('CULTIVATOR/PRODUCER:',sample_client),
                     c('SPECIES:',sample_species),
                     c('CULTIVAR:', sample_cultivar),
                     c('GENERATION DATE:', sample_gen_date)),
      align = c('right','left'),
      line = list(width = 1, color = 'black'),
